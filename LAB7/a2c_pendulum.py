...
class Actor(nn.Module):
    def __init__(self, in_dim: int, out_dim: int):
        ...
        initialize_uniformly(self.mean_layer , init_w=3e-3) # Smaller weights for output "may" helps?
        initialize_uniformly(self.log_std_layer , init_w=3e-3)
    ...
    def forward(self, state: torch.Tensor) -> torch.Tensor:
        ...
        mean = torch.tanh(self.mean_layer(x)) * 2.0 # Scale tanh output to [-2.0, 2.0] for Pendulum
